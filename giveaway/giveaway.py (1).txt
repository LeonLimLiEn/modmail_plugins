...
async def setup(bot: "ModmailBot") -> None:
    # Make load/reload safe: drop any stale instance first so a re-load
    # never raises `ClientException: Cog named 'Giveaway' already loaded`.
    if bot.get_cog("Giveaway") is not None:
        await bot.remove_cog("Giveaway")
